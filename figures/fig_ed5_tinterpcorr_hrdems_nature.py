...
ax.vlines([],[],[],color=col[0],label='0.1 km')
...
ax.fill_between([],[],color=col[0],label='0.1 km')
...
ax.text(800,5,'$\overline{s_{0}(\Delta t)}$: correlated until 0.1 km',bbox= dict(boxstyle='round', facecolor='white', alpha=0.7),color='tab:orange')
