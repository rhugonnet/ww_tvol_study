...
def add_compartment_world_map(fig,pos,anom=None,ymarg=None,label=None,label2=None):
    ...
    if label is not None:
        out_axes.text(0.05, 0.025, label, transform=out_axes.transAxes,fontsize=14, fontweight='bold', ha='left', va='bottom',zorder=30)
    ...
    if label2 is not None:
        out_axes_2.text(0.5, 0, label2, transform=out_axes_2.transAxes, fontsize=14, fontweight='bold', ha='center', va='bottom',
              zorder=30)
...
sub_ax_2 = fig.add_axes([0.4, 0.02, 0.4, 0.05])
sub_ax_2.set_xticks([])
sub_ax_2.set_yticks([])
sub_ax_2.spines['top'].set_visible(False)
sub_ax_2.spines['left'].set_visible(False)
...
axleg5 = fig.add_axes([-0.32,-0.43,1,1],projection=ccrs.Robinson(),label='legend_5')
...
axleg5.text(5000000,-1000000,'100%',horizontalalignment='center',verticalalignment='center')
...
axleg5.text(2500000,-1000000,'39%',horizontalalignment='center',verticalalignment='center')
...
axleg5.text(0,-1000000,'10%',horizontalalignment='center',verticalalignment='center')

axleg5.text(-1000000,-600000,'95% CI',horizontalalignment='right',verticalalignment='center')
axleg5.text(-1000000,-1000000,'Tile size',horizontalalignment='right',verticalalignment='center')
